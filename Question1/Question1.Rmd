...
output:
  pdf_document:
    ...
    fig_height: 3.5
abstract: |
 This document aims to use global Covid data in order to investigate patterns in Covid-19 statistics. The data was provided by Our World in Data (OWID). Primarily, this anaylsis will focus on continent level differences in Covid-19 trends.
---
...
source('code/CovidDeathfunctions.R')
source('code/demographyPlot.R')
source('code/plotICUvHOSP.R')
